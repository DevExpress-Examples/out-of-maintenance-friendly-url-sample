...
Imports FriendlyUrlSample.Web

' For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
Partial Public Class FriendlyUrlSampleAspNetApplication
    Inherits WebApplication
    Private module1 As DevExpress.ExpressApp.SystemModule.SystemModule
    Private module2 As DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule
    Private module3 As FriendlyUrlSample.Module.FriendlyUrlSampleModule
    Private module4 As FriendlyUrlSample.Module.Web.FriendlyUrlSampleAspNetModule
...
#End Region
    ...
    End Function
    Private Sub FriendlyUrlSampleAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
        e.Updater.Update()
        e.Handled = True
#Else
...
#End If
    ...
    Private Sub InitializeComponent()
        ...
        Me.module3 = New FriendlyUrlSample.Module.FriendlyUrlSampleModule()
        Me.module4 = New FriendlyUrlSample.Module.Web.FriendlyUrlSampleAspNetModule()
        ...
        ' 
        Me.ApplicationName = "FriendlyUrlSample"
